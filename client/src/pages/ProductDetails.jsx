...
const ProductDetails = () => {
  ...
  useEffect(() => {
    setThumbnail(product?.image && product.image.length > 0 ? product.image[0] : null);
  }, [product]);
  return (
    product && (
      <div className="mt-12">
        ...
        <div className="flex flex-col md:flex-row gap-16 mt-4">
          <div className="flex gap-3">
            {product.image && product.image.length > 0 && (
              <>
                ...
                <div className="border border-gray-500/30 max-w-100 rounded overflow-hidden">
                  <img 
                    src={thumbnail || 'https://via.placeholder.com/400x400?text=No+Image'} 
            ...
            {(!product.image || product.image.length === 0) && (
              <div className="border border-gray-500/30 max-w-100 rounded overflow-hidden flex items-center justify-center h-64 bg-gray-100">
